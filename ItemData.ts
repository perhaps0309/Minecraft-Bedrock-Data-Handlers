import { EntityComponentTypes, EntityEquippableComponent, EntityInventoryComponent, EquipmentSlot, ItemStack, Player, Vector3 } from "@minecraft/server";
import { EffectDataT, EnchantmentDataT, ItemEffectDataT } from "../../../types"; // Use our custom types
import { MinecraftFormatCodes, removeFormat } from "../../chatFormat"; // Import the chatFormat functions 
import { enchantmentTitles } from "../../enchantments/enchantmentHandler"; // To be revised
